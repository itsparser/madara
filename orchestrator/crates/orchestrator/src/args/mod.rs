...
pub mod validate_params {
    ...
    pub(crate) fn validate_da_params(ethereum_da_args: &EthereumDaCliArgs) -> Result<DaValidatedArgs, String> {
        if ethereum_da_args.da_on_ethereum {
            Ok(DaValidatedArgs::Ethereum(super::da::EthereumDaValidatedArgs {
                rpc_url: ethereum_da_args
                    .ethereum_da_rpc_url
                    .clone()
            ...
            Err("Only Ethereum DA is supported as of now".to_string())
        }
    }
    ...
    pub(crate) fn validate_settlement_params(
        ...
        match (ethereum_args.settle_on_ethereum, starknet_args.settle_on_starknet) {
            ...
            (true, false) => {
                ...
                let ethereum_params = super::settlement::EthereumSettlementValidatedArgs {
            ...
            (false, true) => {
                let starknet_params = super::settlement::StarknetSettlementValidatedArgs {
    ...
    pub(crate) fn validate_prover_params(
        ...
        match (sharp_args.sharp, atlantic_args.atlantic) {
            ...
            (true, false) => Ok(ProverValidatedArgs::Sharp(super::prover::sharp::SharpValidatedArgs {
            ...
            (false, true) => Ok(ProverValidatedArgs::Atlantic(super::prover::atlantic::AtlanticValidatedArgs {
                ...
                atlantic_rpc_node_url: atlantic_args
                    ...
                    .clone()
                    .expect("Atlantic RPC node URL is required"),
